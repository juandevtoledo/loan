...
public class RetrofitPaymentPlansOperationV4Test {
    ...
    private PaymentPlanResponseV4 paymentPlanResponseV4;
    ...
    public void setup() throws IOException {
        ...
        paymentPlanResponseV4 = Sample.paymentPlanV4Builder();
        this.stubUrl = "/credits/v4/client/".concat(idClient).concat("/payment-plan");
    }
    ...
    public void sdkShouldReturnPaymentPlans() throws IOException {
        ...
        String responseBody = objectMapper.writeValueAsString(paymentPlanResponseV4);
        StubMapping stubMapping = wireMockRule.stubFor(
                post(urlEqualTo(stubUrl))
                        .willReturn(aResponse()
                                .withStatus(200)
                                .withBody(responseBody)));
        Either<ResponseBody, PaymentPlanResponseV4> response = paymentPlansOperation.getPaymentPlansV4ByClient(new HashMap<>(), paymentPlanRequestV3);
